  ...
  return (
    <div className=" p-4 items-center text-center bg-slate-700">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 text-gray-400 items-center h-screen">
        <div className="flex flex-col  text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg bg-base-300 transition-transform duration-300 hover:scale-105 cursor-pointer">
          <h3 className="my-4 font-bold">React</h3>
          <Image src={ReactLogo} alt="react-svg" width={100} height={100} />
          
        </div>

        <div className="flex flex-col  text-center bg-base-50  items-center mx-auto p-4 my-4 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 cursor-pointer">
        ...
        <div className="flex flex-col   text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg  transition-transform duration-300 hover:scale-105 cursor-pointer">
