  ...
  return (
    <div className=" p-4 items-center text-center bg-slate-700">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 text-gray-400 items-center h-screen">
        ...
        className="flex flex-col  text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg bg-base-300 poppins">
        ...
        className="flex flex-col  text-center bg-base-50  items-center mx-auto p-4 my-4 rounded-lg shadow-md">
        ...
        whileHover={{scale: 1.3,}}
        transition={{type: 'bounce'}}
        className="flex flex-col  text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg bg-base-30">
        ...
        whileHover={{scale: 1.3,}}
        transition={{type: 'bounce'}}
        className="flex flex-col  text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg bg-base-300">
        ...
        whileHover={{scale: 1.3,}}
        transition={{type: 'bounce'}}
        className="flex flex-col   text-center items-center mx-auto p-4 my-4 rounded-md shadow-lg">
